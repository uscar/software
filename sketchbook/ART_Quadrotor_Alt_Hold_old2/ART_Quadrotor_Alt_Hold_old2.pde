...
void loop() {
  ...
  digitalWrite(ping,LOW);
  pinMode(ping,INPUT);
  sonarReading = pulseIn(ping, HIGH, PULSEDUR);
  ...
  if ( millis() - timer1 > 10 ) { // timer at 100 Hz
    ...
    pilotThrottle = RCInput[2] + 200;
 /*   if (pilotThrottle > 1638) {
      pilotThrottle = 1638;
    }*/
   // pilotThrottle = (((pilotThrottle-1140)/(1638-1140))*(2000-1100)) + 1100;
   // Serial.println(pilotThrottle);
