...
public:
	...
	line_finder(ros::NodeHandle& _nh): nh(_nh), sub_scan(nh, "/scan", 10), sub_arduino(nh, "/arduino/attitude", 10), 
										sync_subs(Policy_sync_subs(10), sub_scan, sub_arduino) 
		{
			pub_cloud = nh.advertise<sensor_msgs::PointCloud>("/world", 10);
			pub_lines = nh.advertise<art_laser::Lines>("/lrfLines", 10);
